...
from PyQt6.QtWidgets import (
    ...
    QHeaderView, QRadioButton, QButtonGroup, QProgressBar, QFlowLayout
)
...
class VotingSessionWindow(QWidget):
    ...
    def init_ui(self):
        ...
        left_layout.addWidget(self.voted_scroll)
